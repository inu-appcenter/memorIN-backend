...
public enum ErrorCode {
    ...
    // 팔로우 (follows)
    FOLLOW_001(HttpStatus.NOT_FOUND, "존재하지 않는 팔로우 관계입니다."),
    ...
    FOLLOW_005(HttpStatus.CONFLICT, "PENDING 상태의 팔로우 요청이 아닙니다."),
    ...
    CHAT_ROOM_MEMBERS_001(HttpStatus.NOT_FOUND, "존재하지 않는 참여자입니다."),
